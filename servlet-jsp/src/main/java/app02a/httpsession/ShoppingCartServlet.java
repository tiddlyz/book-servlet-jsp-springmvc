...
public class ShoppingCartServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        products.add(new Product(1, "Bravo 32' HDTV",
                "Low-cast HDTV from renowned TV manufacturer", 159.95F));
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        } else if(url.endsWith("/viewProductDetails")){
            sendProductDetails(req, resp);
        } else if(url.endsWith("viewCart")){
            showCart(req, resp);
        }
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(product !=null && quantity >=0 ){
            ...
            // Get the current session associated with this request, if there is no session, create one
